...
I am currently learning how to manage with Ubuntu, beginning with Python- _Romani ite domum!_-, and ocassionally, when the chance comes
...
I continue learning Python, trying to understand how to use it with Windows 10 and Pycharm because my old dear computer doesn't work very well with Windows 10 and Linux and I need Windows to use some proffesional software jet not available for Linux like autocad. I am not really very fond on Windows but I have been fighting with it for a few years, so I can manage more or less, and overcoming compatibility problems however I am able to do it, or not..., sometimes trying to install Linux in my computer which almost exploded, and then I found myself reinstalling windows and all programs again, which is really tedious. 
